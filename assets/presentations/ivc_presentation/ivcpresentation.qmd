...
- If $\mathcal{P}$ makes weak descriptive equivalence false, and if $S_M$ contains TEC, then any $\mathcal{P}$-sufficient Leitgeb basis will have to include some sentences expressing (quasi&#8209;)aesthetic judgments.
  - N.B.: If we follow McDowell, our $\mathcal{P}$ should definitely make strong descriptive equivalence false. 
  - But I don't see why weak descriptive equivalence would have to be a problem for him, since---in contrast to e.g. the notion of confirmation developed in *Testability and Meaning*---probabilistic confirmation doesn't require anything like an *analysis* of TEC in terms of observable predicates, but merely the possibility of a competent speaker *noticing* that applicability of a TEC and certain observable predicates tend to co-occur.
- But if weak descriptive equivalence were false, it would be a problem for empiricists (if they want a basis consisting of observation sentences and if Kant (and Kantians like Ginsborg and McDowell) are right about aesthetic judgment having mere subjective generality for lack of picking up on any observable property of the object).
...
- I think probably no. Conditionalizing on the observation that certain predicates tend to occur together will lead to a probability measure on which they confirm each other.
...
- I suggest that Inductive Logic would solve both issues: Giving a purely syntactic notion of probability, which endorses weak descriptive equivalence.
