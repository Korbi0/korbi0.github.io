---
title: "Verifiability, Probability, Thick Ethical Concepts"
...
- Judgments containing TEC share some similarities with empirical, and some with aesthetic judgments[^note]
...
[^note]: Following [@mcdowell1981noncognitivism] on the cognitive basis for application of TEC and [@cavell2002AestheticProblems] on judgments about what we should say.
...
- Can we adapt the concept of a "sufficient basis" from *Testability and Meaning* to frame our question?
...
- This would be a problem for empiricists (if they want a basis consisting of observation sentences and if Kant is right about aesthetic judgment having mere subjective generality).
