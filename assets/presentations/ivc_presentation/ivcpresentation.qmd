...
- But honestly I find the self-application 
:::
...
My frame for thinking about TEC can be sketched by the following two quotes from Bernard Williams and Hannah Ginsborg:
...
> I take my own pleasurable response to the object to be **appropriate to or called-for by the object**. [...] But [...] since beauty is not an objective property of things I cannot claim that my finding the flowering cherry beautifuyl is appropriate to the flowering cherry just because it is, in fact, beautiful. [..] there are **no test criteria** I can employ to justify my claim. [@ginsborgAestheticNormativityKnowing2020, p. 57-8]

:::

::: {.column width="30%"}

![](images/Bernard-Williams.jpg){width=80%}

![](images/ginsborg.jpg){width=80%}
...
- They cannot be reduced to observation judgments, if we follow @mcdowell1981noncognitivism in rejecting *Descriptive Equivalence*[^1]:
...
[^1]: So if McDowell (and Putnam and Williams) are right, they fail OVC's test for meaningfulness.
...
- This would be a problem for empiricists (if they want a basis consisting of observation sentences and if Kant / the Kantian tradition is right about aesthetic judgment having mere subjective generality for lack of picking up on any observable property of the object).
